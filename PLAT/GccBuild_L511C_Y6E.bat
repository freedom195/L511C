...
set BUILD_PRO_NAME=L511C_Y6E
set BUILD_PRO_TARGET=L511C_Y6E
...
rem merge comdb_ap_lib.txt and omdb_cp.txt to .\tools\comdblib.txt
if exist %COMDBLIB_PATH%\comdb_ap_lib.txt (
	.\tools\LogPrePass.exe -I %COMDBLIB_PATH%\comdb_ap_lib.txt ^
	                       -I .\prebuild\FW\lib\gcc\%CHIP_TYPE%\%CPBIN_SUBPATH%\comdb_cp.txt ^
						   -h .\tools\debug_log_no_use.h  -d .\tools\comdblib.txt
						   
	del /q .\tools\debug_log_no_use.h
)
